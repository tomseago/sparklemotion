...
class GlslShader(
    ...
    override fun createRenderer(surface: Surface, renderContext: RenderContext): Renderer {
        ...
        val pooledRenderer = renderContext.registerPooled(poolKey) { PooledRenderer(glslProgram, params) }
    ...
    override fun createRenderer(surface: Surface): Renderer {
        val glslRenderer = GlslBase.manager.createRenderer(glslProgram, params)
    ...
    class PooledRenderer(glslProgram: String, params: List<Param>) : baaahs.PooledRenderer {
        val glslRenderer = GlslBase.manager.createRenderer(glslProgram, params)
